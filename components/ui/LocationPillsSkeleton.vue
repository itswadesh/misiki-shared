<template>
  ...
  >
    ...
    <rect
      ...
      width="400"
      height="160"
      clip-path="url(#dbj28dmu5ej)"
      style="fill: url('#uooau3ta4md');"
    />
    <defs>
      <clipPath id="dbj28dmu5ej">
      ...
      <linearGradient id="uooau3ta4md">
        <stop offset="-2.75797" stop-color="#f3f3f3" stop-opacity="1">
          <animate
        ...
        <stop offset="-1.75797" stop-color="#ecebeb" stop-opacity="1">
          <animate
            attributeName="offset"
            values="-2; 2"
            dur="1.2s"
        ...
        <stop offset="-0.757967" stop-color="#f3f3f3" stop-opacity="1">
          <animate
            attributeName="offset"
            values="-1; 3"
            dur="1.2s"
